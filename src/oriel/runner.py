...
def run_cases(store: TrialStore, task: str, model_name: str, prompt_version: str, model: Model, cases: list[Case]) -> RunSummary:
    passed = 0
    for case in cases:
        ...
        store.record(
            task, case.id, model_name, prompt_version, case.input_text, result.passed,
